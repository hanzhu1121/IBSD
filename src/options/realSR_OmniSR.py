...
def parse_config(local_test=True):
    ...
    # Data Preparation
    parser.add_argument('--dataroot', type=str, default='../Dataset/DRealSR/Train_x4')
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='OmniSR-X4', help='')
    ...
    parser.add_argument('--epochs', type=int, default=240, help='number of epochs to train for')
    ...
    parser.add_argument('--workers', type=int, default=4, help='number of threads to prepare data.')

    ## SRModel Settings
    # parser.add_argument('--pretrain', type=str, default='./models/RCAN_BIX2.pt')
    parser.add_argument('--pretrain', type=str, default='')
    parser.add_argument('--model', type=str, default='OmniSR', help='[RRDB_net | srresnet | EDSR | RCAN]')
