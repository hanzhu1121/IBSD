...
def parse_config(local_test=True):
    ...
    parser.add_argument('--decay_step', type=list, default=[3e5, 6e5, 8e5, 1e4], help='')
...
#     parser.add_argument('--decay_step', type=list, default=[5e4, 1e5, 2e5, 3e5], help='')
    parser.add_argument('--epochs', type=int, default=420, help='number of epochs to train for')
